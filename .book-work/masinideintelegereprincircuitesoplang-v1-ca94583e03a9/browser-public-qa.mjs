...
const root=path.resolve('docs/books/machines/of/understanding/through/circuits/bk-629bc39de504437d'),qa=path.resolve('.book-work/masinideintelegereprincircuitesoplang-v1-ca94583e03a9/qa');
const results=[];
