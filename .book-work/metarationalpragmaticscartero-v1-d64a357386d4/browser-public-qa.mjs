...
const root=path.resolve('docs/books/meta/rational/pragmatics/bk-440dfae7c4994cdc'),qa=path.resolve('.book-work/metarationalpragmaticscartero-v1-d64a357386d4/qa');
const results=[];
