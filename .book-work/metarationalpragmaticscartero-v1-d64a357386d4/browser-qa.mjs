...
const root=path.resolve('.book-work/metarationalpragmaticscartero-v1-d64a357386d4/book'),qa=path.resolve('.book-work/metarationalpragmaticscartero-v1-d64a357386d4/qa');
const results=[];
