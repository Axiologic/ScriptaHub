...
const results=[];
for(const page of ['en/full_content.html','en/short_content.html','ro/short_content.html']){
...
await fs.writeFile(path.join(qa,'browser-partial-review.json'),JSON.stringify(results,null,2)+'\n');console.log('Passed '+results.length+' browser page/viewport checks');
