...
for book in [{'workdir': '.book-work/beforeexplanationoutfinitism-v1-3a155e31f5cc', 'language': 'en', 'filename': 'Before_Explanation_Outfinitism.docx', 'title': 'Before Explanation'}]:
