...
for para in doc.xpath('//main/p'):
    ...
    elif re.fullmatch(r'CHAPTER \d+',txt) or txt in ['PROLOGUE','EPILOGUE','CONCEPTUAL APPENDIX','METHODOLOGICAL NOTE','SOURCES AND LANDMARKS']:para.set('class','chapter-label')
