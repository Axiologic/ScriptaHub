# Predator in the Name of the Dead — English narrated introduction

Completed **2:40**, four scenes and 24 single-sentence clips. The public preview flag records pending user listening, not missing narration.

Source: `docs/books/predator/in/the/name/of/the/dead/bk-040d76eacde74afb/en/full_content.html`, `edition-1`, HTML SHA-256 `052d16745798aebef147b736569e9605f9bcacf2068b5ff1064055d2d2f328be`. Full text was extracted and indexed; selected chapter-aligned openings, body passages and endings were inspected. This does not claim every word or every chapter was manually reviewed. Exact substantive UTF-16 evidence spans, source hash, chapter map and limitations are retained in working metadata.
...
Delivery: `docs/books/predator/in/the/name/of/the/dead/bk-040d76eacde74afb/Animation/predator-in-the-name-of-the-dead-introduction.shf`, plus only this book's manifest animation record. Root integration generates the shared-player entry page and aggregate catalogue. Readers and release workspaces were not modified.

```sh
node presentations/predator-in-the-name-of-the-dead/work/art.mjs
node presentations/predator-in-the-name-of-the-dead/render_voice.mjs
node presentations/predator-in-the-name-of-the-dead/build.mjs
SCRIPTA_CDP_URL=http://127.0.0.1:9246 node tools/shf/qa-film.mjs presentations/predator-in-the-name-of-the-dead
```
