...
const flower=(x,y,k)=>[fill(`M${x-12*k} ${y}Q${x-24*k} ${y+110*k} ${x+17*k} ${y+215*k}`,c,cn),fill(`M${x-65*k} ${y-25*k}Q${x-49*k} ${y-133*k} ${x} ${y-122*k}Q${x+51*k} ${y-137*k} ${x+65*k} ${y-25*k}Q${x} ${y+19*k} ${x-65*k} ${y-25*k}Z`,wax,wn),tint(path(`M${x-62*k} ${y-25*k}Q${x} ${y-62*k} ${x+62*k} ${y-25*k}`,c,7),cn)];
