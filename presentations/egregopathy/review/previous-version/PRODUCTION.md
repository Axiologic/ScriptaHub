# Egregopathy — narrated book introduction

Finished narrated preview: **2:38.082**, four authored scenes and 20 English single-sentence clips, each 8–16 words. The complete script passed authoring and parent editorial review before local voice generation. Its coherent book-level why/how/what introduces the source and provides a specific reason and starting point for reading.

Canonical reader: `docs/books/egregopathy/bk-7fb2b8ceda1b4449/en/full_content.html`; edition `edition-1`; SHA-256 `f83e1866c4641bd3e9348d7cd71933519cc086aecea828d84b71cc3ecdbabe22`. Source extraction, UTF-16 section offsets, chapter map, exact supporting spans and full editable script remain in `source/` and `work/`. Review covered the opening, chapter structure, conclusion, methodological limits and selected substantive passages; it does not certify every line or reference. Source claims remain the book’s arguments, not independently validated findings.
