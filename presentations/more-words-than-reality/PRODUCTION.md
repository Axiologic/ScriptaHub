# More Words Than Reality — English book introduction
...
- Source: `docs/books/more/words/than/reality/bk-a2bd69dde21e44e8/en/full_content.html`, active `edition-1`.
- Canonical HTML SHA-256: `5335942bd4a3c0a6ba35acbd863d0b1b39636f3d431206aee138f11e35a764f7`.
- Duration: **2:39** (159002 ms), four chapters, 20 single-sentence narration clips.
...
- Public film: `docs/books/more/words/than/reality/bk-a2bd69dde21e44e8/Animation/more-words-than-reality-introduction.shf`.
...
```sh
node presentations/more-words-than-reality/art.mjs
node presentations/more-words-than-reality/render_voice.mjs
node presentations/more-words-than-reality/build.mjs
SCRIPTA_CDP_URL=http://127.0.0.1:9235 node tools/shf/qa-film.mjs presentations/more-words-than-reality
```
