# OMNIS — English narrated introduction

Completed **2:52**, four scenes and 24 single-sentence clips. The public preview flag records pending user listening, not missing narration.

Source: `docs/books/omnis/bk-edee28bde0ac4b92/en/full_content.html`, `edition-1`, HTML SHA-256 `f799cfac2c0b65df3d1919aea6c04373e967697a0e7b367600f6242fd20f53af`. Full text was extracted and indexed; selected chapter-aligned openings, body passages and endings were inspected. This does not claim every word or every chapter was manually reviewed. Exact substantive UTF-16 evidence spans, source hash, chapter map and limitations are retained in working metadata.
...
Delivery: `docs/books/omnis/bk-edee28bde0ac4b92/Animation/omnis-introduction.shf`, plus only this book's manifest animation record. Root integration generates the shared-player entry page and aggregate catalogue. Readers and release workspaces were not modified.

```sh
node presentations/omnis/work/art.mjs
node presentations/omnis/render_voice.mjs
node presentations/omnis/build.mjs
SCRIPTA_CDP_URL=http://127.0.0.1:9246 node tools/shf/qa-film.mjs presentations/omnis
```
