...
else if(i===2){obj('laundry',597,395,[fill('M-371 108V-118H-220V108Z',c,cn),n('ellipse',{cx:-296,cy:-26,rx:49,ry:74,fill:o}),rect(-169,5,505,23,o,on),path('M-130 28V137M287 28V137','$ink',13)],'A lower-world laundry exposes ordinary maintenance and bodily discomfort');a.person('visitor',755,365,{coat:c,night:cn,pose:'concerned',scale:.86});obj('shoes',864,486,[fill('M-55 -4Q-24 -25 -6 -2L19 14H-55Z',c,cn),fill('M24 -4Q49 -25 65 -2L94 14H24Z',c,cn)],'The novel makes reduced freedom tangible through an unfamiliar body');a.reveal('shoes',3);}
