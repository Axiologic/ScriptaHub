# The Cascade of the New — English narrated introduction
...
Source: `docs/books/the/cascade/of/the/new/bk-1215d047d25b4769/en/full_content.html`, `edition-1`, HTML SHA-256 `748833dbcce80f5521536cdd8f9f01bd9bc9a0bb1a2991c7d3738aae5e838658`. Full text was extracted and indexed; selected chapter-aligned openings, body passages and endings were inspected. This does not claim every word or every chapter was manually reviewed. Exact substantive UTF-16 evidence spans, source hash, chapter map and limitations are retained in working metadata.
...
Delivery: `docs/books/the/cascade/of/the/new/bk-1215d047d25b4769/Animation/the-cascade-of-the-new-introduction.shf`, plus only this book's manifest animation record. Root integration generates the shared-player entry page and aggregate catalogue. Readers and release workspaces were not modified.

```sh
node presentations/the-cascade-of-the-new/work/art.mjs
node presentations/the-cascade-of-the-new/render_voice.mjs
node presentations/the-cascade-of-the-new/build.mjs
SCRIPTA_CDP_URL=http://127.0.0.1:9246 node tools/shf/qa-film.mjs presentations/the-cascade-of-the-new
```
