# OpenDSU — English book introduction
...
```sh
node presentations/opendsu/art.mjs
node presentations/opendsu/render_voice.mjs
node presentations/opendsu/build.mjs
SCRIPTA_CDP_URL=http://127.0.0.1:9235 node tools/shf/qa-film.mjs presentations/opendsu
```
