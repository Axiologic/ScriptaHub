# The Wish Series — English narrated introduction
...
Source: `docs/books/the/wish/series/bk-abb238da37c646c9/en/full_content.html`, `edition-1`, HTML SHA-256 `8c0409d5ae138e82e34863317c1b716682ab8ae4080c1c5d89604745452d4e3d`. Full text was extracted and indexed; selected chapter-aligned openings, body passages and endings were inspected. This does not claim every word or every chapter was manually reviewed. Exact substantive UTF-16 evidence spans, source hash, chapter map and limitations are retained in working metadata.
...
Delivery: `docs/books/the/wish/series/bk-abb238da37c646c9/Animation/the-wish-series-introduction.shf`, plus only this book's manifest animation record. Root integration generates the shared-player entry page and aggregate catalogue. Readers and release workspaces were not modified.

```sh
node presentations/the-wish-series/work/art.mjs
node presentations/the-wish-series/render_voice.mjs
node presentations/the-wish-series/build.mjs
SCRIPTA_CDP_URL=http://127.0.0.1:9246 node tools/shf/qa-film.mjs presentations/the-wish-series
```
