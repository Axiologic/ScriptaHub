# The Fragmented Future — narrated book introduction

Finished narrated preview: **2:33.797**, four authored scenes and 20 English single-sentence clips, each 8–16 words. The complete script passed authoring and parent editorial review before local voice generation. Its coherent book-level why/how/what introduces the source and provides a specific reason and starting point for reading.

Canonical reader: `docs/books/the/fragmented/future/bk-d2ef7506105b422d/en/full_content.html`; edition `edition-1`; SHA-256 `8932d106666f81928dd111526a97763312cc3841ae29fcc82cf1cb10a7a49f3a`. Source extraction, UTF-16 section offsets, chapter map, exact supporting spans and full editable script remain in `source/` and `work/`. Review covered the opening, chapter structure, conclusion, methodological limits and selected substantive passages; it does not certify every line or reference. Source claims remain the book’s arguments, not independently validated findings.
