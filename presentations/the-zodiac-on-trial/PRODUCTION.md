# The Zodiac on Trial — English book introduction
...
- Source: `docs/books/the/zodiac/on/trial/bk-011a9ed7b63d4de9/en/full_content.html`, active `edition-1`.
- Canonical HTML SHA-256: `f905a2baf792a7463ea93cba337662d08c0d39939f6520ff5b802c31d7729b1b`.
- Duration: **2:42** (161723 ms), four chapters, 20 single-sentence narration clips.
...
- Public film: `docs/books/the/zodiac/on/trial/bk-011a9ed7b63d4de9/Animation/the-zodiac-on-trial-introduction.shf`.
...
```sh
node presentations/the-zodiac-on-trial/art.mjs
node presentations/the-zodiac-on-trial/render_voice.mjs
node presentations/the-zodiac-on-trial/build.mjs
SCRIPTA_CDP_URL=http://127.0.0.1:9235 node tools/shf/qa-film.mjs presentations/the-zodiac-on-trial
```
