# The Silicon Shadows and I — narrated SHF introduction
...
- Canonical source: `docs/books/the/silicon/shadows/and/i/bk-78df380b6a7c48f2/en/full_content.html`, `edition-1`. HTML SHA-256 `43bbf06f9ea8884b851faa3a8abedde9bdf91d1ebf1ab27b553c09c12eac92b4`; exact text hash and UTF-16 prose-span claims retained in source/editorial files.
...
Only `docs/books/the/silicon/shadows/and/i/bk-78df380b6a7c48f2/Animation/the-silicon-shadows-and-i-introduction.shf` is published by this workspace, plus its own manifest's animation field. Root integration regenerates the shared-player entry page and aggregate catalogue. No reader, release workspace, historical source or unrelated manifest field was deliberately changed.

```sh
node presentations/the-silicon-shadows-and-i/work/art.mjs
node presentations/the-silicon-shadows-and-i/render_voice.mjs
node presentations/the-silicon-shadows-and-i/build.mjs
SCRIPTA_CDP_URL=http://127.0.0.1:9246 node tools/shf/qa-film.mjs presentations/the-silicon-shadows-and-i
```
