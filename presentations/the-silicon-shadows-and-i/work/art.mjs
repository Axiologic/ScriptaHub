...
const cup=(id,x,y,k=1)=>shape(id,x,y,[material('M-72 -71H66L55 63Q0 91 -59 62Z',coral,coralN),tint(path('M66 -48Q139 -47 118 8Q100 45 59 33',coral,12),coralN),path('M-8 -69L7 -29L-12 1L9 31L1 65','#402c27',5)],'The narrator’s cracked cup',k);
...
case 5:shape('exit',451,315,[material('M-110 -147H110V147H67V-112H-67V147H-110Z')],'A doorway requires an actually usable passage');shape('leaf',451,332,[material('M-67 -129H67V130H-67Z',coral,coralN)],'The initially closed door');boat('route',858,384,.7);a.reveal('route',4);a.hide('leaf',4);a.person('traveller',309,349,{coat:coral,night:coralN,hairStyle:'long',pose:'concerned',scale:.62});a.move('traveller',5,685,385,3400);a.move('route',6,887,384);break;
