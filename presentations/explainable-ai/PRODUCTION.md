# Explainable AI — English book introduction
...
- Source: `docs/books/explainable/ai/bk-4fdfb9b9174f4146/en/full_content.html`, active `edition-1`.
- Canonical HTML SHA-256: `60b883393a27d434fffe2d52171638178cfe1fc6fa914c6bfb730e61d65dd1d9`.
- Duration: **7:01** (420737 ms), nine chapters, 54 single-sentence narration clips.
...
- Public film: `docs/books/explainable/ai/bk-4fdfb9b9174f4146/Animation/explainable-ai-introduction.shf`.
...
```sh
node presentations/explainable-ai/art.mjs
node presentations/explainable-ai/render_voice.mjs
node presentations/explainable-ai/build.mjs
SCRIPTA_CDP_URL=http://127.0.0.1:9235 node tools/shf/qa-film.mjs presentations/explainable-ai
```
