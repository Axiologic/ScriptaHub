...
case 1:a.person('watch',402,386,{coat:ochre,night:ochreN,pose:'concerned',scale:.46});a.move('watch',5,471,365,2800);shape('ridge',596,330,[material('M-395 79L-252 -12L-122 24L29 -60L173 9L295 -34L395 79Z')],'The empty northern ridge');flame('camp',267,421,.42);a.reveal('camp',3);a.objects.push(a.objects.splice(a.objects.findIndex(o=>o.id==='watch'),1)[0]);break;
