# S*LM — English book introduction
...
```sh
node presentations/s-lm/art.mjs
node presentations/s-lm/render_voice.mjs
node presentations/s-lm/build.mjs
SCRIPTA_CDP_URL=http://127.0.0.1:9235 node tools/shf/qa-film.mjs presentations/s-lm
```
