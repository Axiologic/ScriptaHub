...
the footer’s solid forest green (`#075e54`), with light text and mint accents
against the cool grey discovery field. View Book uses the same solid green background, white text and compact
button styling as Create. Keep actual
...
and Escape restore the two choices and focus. Preserve entered text across interface-language changes.
