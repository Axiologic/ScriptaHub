# SOLIPSICON — English narrated introduction
...
Delivery: `docs/books/solipsicon/bk-ccf2639682484633/Animation/solipsicon-introduction.shf`, plus only this book's manifest animation record. Root integration generates the shared-player entry page and aggregate catalogue. Readers and release workspaces were not modified.

```sh
node presentations/solipsicon/work/art.mjs
node presentations/solipsicon/render_voice.mjs
node presentations/solipsicon/build.mjs
SCRIPTA_CDP_URL=http://127.0.0.1:9246 node tools/shf/qa-film.mjs presentations/solipsicon
```
