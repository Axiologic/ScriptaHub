# Autopsy of Future Emotions — English narrated introduction

Completed **2:57**, four scenes and 24 single-sentence clips. The public preview flag records pending user listening, not missing narration.

Source: `docs/books/autopsy/of/future/emotions/bk-a91b1512505e4224/en/full_content.html`, `edition-1`, HTML SHA-256 `514ed1e92986fa831cf55536831d72a25b4244c6bc3a776088561907ab47f3d2`. Full text was extracted and indexed; selected chapter-aligned openings, body passages and endings were inspected. This does not claim every word or every chapter was manually reviewed. Exact substantive UTF-16 evidence spans, source hash, chapter map and limitations are retained in working metadata.
...
Delivery: `docs/books/autopsy/of/future/emotions/bk-a91b1512505e4224/Animation/autopsy-of-future-emotions-introduction.shf`, plus only this book's manifest animation record. Root integration generates the shared-player entry page and aggregate catalogue. Readers and release workspaces were not modified.

```sh
node presentations/autopsy-of-future-emotions/work/art.mjs
node presentations/autopsy-of-future-emotions/render_voice.mjs
node presentations/autopsy-of-future-emotions/build.mjs
SCRIPTA_CDP_URL=http://127.0.0.1:9246 node tools/shf/qa-film.mjs presentations/autopsy-of-future-emotions
```
