...
if(i<2){shipment();obj('instruction-left',307,263,[path('M-50 0H65M65 0L39 -25M65 0L39 25',c,12),text('Valid',0,-38,34)],'One valid instruction directs movement');obj('instruction-right',895,263,[path('M50 0H-65M-65 0L-39 -25M-65 0L-39 25',c,12),text('Valid',0,-38,34)],'An incompatible valid instruction prevents the same movement');a.reveal('instruction-right',3);obj('waiting',600,557,[text('Still waiting',0,0,34)],'The drone complies by doing nothing');a.reveal('waiting',4);}
else if(i===2){obj('workshop',611,386,[fill('M-400 -128H-99V91H-400Z',c,cn),...[-83,-23,37].map(y=>rect(-374,y,245,12,o,on)),rect(-371,-116,75,27,o,on,8),rect(-268,-53,101,27,o,on,8),rect(-376,8,115,27,o,on,8),fill('M-29 56H387V88H-29Z',o,on),path('M1 88V158M345 88V158','$ink',13)],'A goods workshop provides access without eliminating the burdens behind it');a.person('allocator',766,289,{coat:c,night:cn,pose:'open',scale:.85});obj('burden',1038,288,[text('Water',0,-33,33),text('Time',0,16,33),text('Care',0,65,33)],'The allocation view uses consequences in place of a price');a.reveal('burden',3);}
