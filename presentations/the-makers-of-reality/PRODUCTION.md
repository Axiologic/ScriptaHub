# The Makers of Reality — English narrated introduction

Completed **2:42**, four scenes and 24 single-sentence clips. The public preview flag records pending user listening, not missing narration.

Source: `docs/books/the/makers/of/reality/bk-43199879a8f44d72/en/full_content.html`, `edition-1`, HTML SHA-256 `0854c37c69441c1c25ea8201f70cf3f461d488f4639c30fe3db599043d4be1b9`. Full text was extracted and indexed; selected chapter-aligned openings, body passages and endings were inspected. This does not claim every word or every chapter was manually reviewed. Exact substantive UTF-16 evidence spans, source hash, chapter map and limitations are retained in working metadata.
...
Delivery: `docs/books/the/makers/of/reality/bk-43199879a8f44d72/Animation/the-makers-of-reality-introduction.shf`, plus only this book's manifest animation record. Root integration generates the shared-player entry page and aggregate catalogue. Readers and release workspaces were not modified.

```sh
node presentations/the-makers-of-reality/work/art.mjs
node presentations/the-makers-of-reality/render_voice.mjs
node presentations/the-makers-of-reality/build.mjs
SCRIPTA_CDP_URL=http://127.0.0.1:9246 node tools/shf/qa-film.mjs presentations/the-makers-of-reality
```
