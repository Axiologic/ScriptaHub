# The Science and Wisdom of Limits — English narrated introduction
...
Source: `docs/books/the/science/and/wisdom/of/limits/bk-42105645842b4408/en/full_content.html`, `edition-1`, HTML SHA-256 `0cc152d81adb40931fb15924f814ea729229aaa07164f2d4bd9dafd761557560`. Full text was extracted and indexed; selected chapter-aligned openings, body passages and endings were inspected. This does not claim every word or every chapter was manually reviewed. Exact substantive UTF-16 evidence spans, source hash, chapter map and limitations are retained in working metadata.
...
Delivery: `docs/books/the/science/and/wisdom/of/limits/bk-42105645842b4408/Animation/the-science-and-wisdom-of-limits-introduction.shf`, plus only this book's manifest animation record. Root integration generates the shared-player entry page and aggregate catalogue. Readers and release workspaces were not modified.

```sh
node presentations/the-science-and-wisdom-of-limits/work/art.mjs
node presentations/the-science-and-wisdom-of-limits/render_voice.mjs
node presentations/the-science-and-wisdom-of-limits/build.mjs
SCRIPTA_CDP_URL=http://127.0.0.1:9246 node tools/shf/qa-film.mjs presentations/the-science-and-wisdom-of-limits
```
