# Vector-Symbolic Intelligence in Practice — English book introduction
...
```sh
node presentations/vector-symbolic-intelligence-in-practice/art.mjs
node presentations/vector-symbolic-intelligence-in-practice/render_voice.mjs
node presentations/vector-symbolic-intelligence-in-practice/build.mjs
SCRIPTA_CDP_URL=http://127.0.0.1:9235 node tools/shf/qa-film.mjs presentations/vector-symbolic-intelligence-in-practice
```
