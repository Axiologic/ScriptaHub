...
else if(i===2){obj('contract-table',600,434,[fill('M-398 -27H398L366 17H-364Z',c,cn),path('M-319 17V98M322 17V98','$ink',13)],'An institutional middle composed of negotiated contracts');obj('continuity-contract',611,333,[fill('M-224 -132L226 -111L211 94L-242 72Z','#e2d5bc','#b9c9c7'),text('Continuity contract',0,-62,40,'#263943'),path('M-169 -19H160M-173 17H178M-179 53H59',c,6)],'Formal ownership remains while conditions accumulate in an operational agreement');obj('condition',875,397,[fill('M-92 -81H90V64H-92Z',o,on),text('Exit',0,-20,35,'#263943'),text('conditions',0,23,31,'#263943')],'The reader must inspect operational exit rather than legal words alone');a.reveal('condition',4);}
