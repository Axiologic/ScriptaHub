# Borrowed Credibility — English book introduction
...
- Source: `docs/books/borrowed/credibility/bk-b261862e55a34094/en/full_content.html`, active `edition-1`.
- Canonical HTML SHA-256: `2685d030c8d3342b144685f86cbb4f48db2e7adbafa2c111aa4c7f8cb6878c09`.
- Duration: **7:00** (420150 ms), nine chapters, 54 single-sentence narration clips.
...
- Public film: `docs/books/borrowed/credibility/bk-b261862e55a34094/Animation/borrowed-credibility-introduction.shf`.
...
```sh
node presentations/borrowed-credibility/art.mjs
node presentations/borrowed-credibility/render_voice.mjs
node presentations/borrowed-credibility/build.mjs
SCRIPTA_CDP_URL=http://127.0.0.1:9235 node tools/shf/qa-film.mjs presentations/borrowed-credibility
```
