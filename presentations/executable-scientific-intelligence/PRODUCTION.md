# Executable Scientific Intelligence — book introduction

English narrated SHF preview, **12:14**, 14 chapters and 98 complete single-sentence narration clips. This is an invitation to read edition 1, with substantive samples and concrete starting points; it is not a complete summary or a product demonstration.
...
Visual identity: Scientific circuit instrument. Flat Color, Light and Dark variants use the shared Red Hat Display and Red Hat Text fonts. Custom vectors keep semantic roles explicit and do not use a recurring human presenter or a copied book-film layout. Image inspection and adaptation decisions are recorded in `work/visual-bible.json`.
...
```sh
node presentations/executable-scientific-intelligence/work/art.mjs
node presentations/executable-scientific-intelligence/render_voice.mjs
node presentations/executable-scientific-intelligence/build.mjs
node tools/shf/qa-film.mjs presentations/executable-scientific-intelligence
```

The shared compiler/runtime live at site level. Public content is `docs/books/executable/scientific/intelligence/bk-4bd29539b9824ee2/Animation/executable-scientific-intelligence-introduction.shf`; its minimal entry is generated from the manifest by the site build. Portable HTML and VTT are in ignored `exports/`. The book's canonical reader and other editions are unchanged.
