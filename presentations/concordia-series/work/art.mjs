...
if(i<2){seminar();obj('formulation',608,240,[rect(-169,-35,338,75,warm,wn,22),text('My considered answer',0,13,32)],'A suggested formulation appears accepted by its speaker');a.reveal('formulation',2);obj('revision',608,240,[rect(-171,-37,342,79,c,cn,22),text('Who framed the options?',0,12,32)],'A participant makes the origin of agreement discussable');a.reveal('revision',4);a.hide('formulation',4);}
else if(i===2){obj('sleeping-city',594,344,[fill('M-414 152V-20H-340V-122H-251V-8H-156V-77H-66V-141H38V-42H132V-112H235V-19H315V-81H414V152Z',c,cn),...Array.from({length:12},(_,j)=>rect(-382+j*65,53,32,7,warm,wn,3))],'A coordinated city becomes quiet during its common sleep');obj('balcony',884,451,[rect(-90,0,180,17,warm,wn),path('M-71 17V80M73 17V80','$ink',9)],'A waking reserve remains physically outside the coordinated sleep');a.person('witness',884,354,{coat:warm,night:wn,pose:'attentive',scale:.55});a.reveal('witness',3);}
