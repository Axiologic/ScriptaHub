...
for(const[i,s]of scenes.entries()){
 ...
 if(i<3){storyPerson(q,'inspector',175,445,{identity:'person-09-neutral',coat:'#cf8d49',scale:.73});storyGesture(q,'inspector',2,'explain');} if(i===3){storyPerson(q,'joint-owner',610,315,{identity:'person-04-neutral',coat:'#589b84',scale:.58});storyGesture(q,'joint-owner',3,'resolve');} s.visual=q.finish('Steel-blue precision workshop: correct local components leave an unowned seam; inspection and explicit joint ownership connect responsibilities without replacing specialist lenses.');
