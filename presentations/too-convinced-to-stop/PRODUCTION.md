# Too Convinced to Stop — English book introduction
...
- Source: `docs/books/too/convinced/to/stop/bk-50bb0111bb624e29/en/full_content.html`, active `edition-1`.
- Canonical HTML SHA-256: `2a2ca1d4db4a16401f886759e20f58b62f155de7bd1a57cbeea4ac4c7090dab2`.
- Duration: **2:37** (156825 ms), four chapters, 20 single-sentence narration clips.
...
- Public film: `docs/books/too/convinced/to/stop/bk-50bb0111bb624e29/Animation/too-convinced-to-stop-introduction.shf`.
...
```sh
node presentations/too-convinced-to-stop/art.mjs
node presentations/too-convinced-to-stop/render_voice.mjs
node presentations/too-convinced-to-stop/build.mjs
SCRIPTA_CDP_URL=http://127.0.0.1:9235 node tools/shf/qa-film.mjs presentations/too-convinced-to-stop
```
