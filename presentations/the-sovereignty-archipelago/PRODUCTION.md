# The Sovereignty Archipelago — English narrated introduction
...
Source: `docs/books/the/sovereignty/archipelago/bk-62e1c503e8e84b83/en/full_content.html`, `edition-1`, HTML SHA-256 `2a0b01e8bed1d6c71e253396b259db62cb6a39385e7327a51f9b628a07a3192f`. Full text was extracted and indexed; selected chapter-aligned openings, body passages and endings were inspected. This does not claim every word or every chapter was manually reviewed. Exact substantive UTF-16 evidence spans, source hash, chapter map and limitations are retained in working metadata.
...
Delivery: `docs/books/the/sovereignty/archipelago/bk-62e1c503e8e84b83/Animation/the-sovereignty-archipelago-introduction.shf`, plus only this book's manifest animation record. Root integration generates the shared-player entry page and aggregate catalogue. Readers and release workspaces were not modified.

```sh
node presentations/the-sovereignty-archipelago/work/art.mjs
node presentations/the-sovereignty-archipelago/render_voice.mjs
node presentations/the-sovereignty-archipelago/build.mjs
SCRIPTA_CDP_URL=http://127.0.0.1:9246 node tools/shf/qa-film.mjs presentations/the-sovereignty-archipelago
```
