...
try{
 ...
 if(frames.some(f=>f.invalid||f.unresolved||!f.connections||f.captionOverlaps.length||f.labelOverflow.length))throw Error('Invalid sampled geometry or caption collision: '+JSON.stringify(frames.filter(f=>f.captionOverlaps.length||f.labelOverflow.length)));
